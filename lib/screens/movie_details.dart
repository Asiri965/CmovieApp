            ...
            return SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Column(
                          children: [
                            Text(data.tagline.toString(),textAlign: TextAlign.center,)
                          ],
                        )
                      ],
                    ),
                  ...
                  data.company!.isEmpty? const SizedBox() : const Text(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      children: List.generate(
                          data.company!.length,
                          (index) => data.company![index].logo.toString() == "" ? const SizedBox() : Card(
                                  elevation: 5,
